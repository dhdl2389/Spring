...
<%@ page import="com.sh.login.UserDTO"%>
...
<body>
	  ...
	  <form id="myForm12" method="post" action="/testing/myForm12">
        ...
        <input type="text" id="user_id" name="user_id" value="아이디" />
        <input type="text" id="user_kakao" name="user_kakao" value="${user_kakao}" />
		<input type="text" id="user_pw" name="user_pw" value="비번" />
		<input type="text" id="address" name="address" value="이메일" />
		<input type="text" id="phone_num" name="phone_num" value="폰번호" />
		...
		<input type="text" id="user_birth" name="user_birth" value="생일" />
		<input type="text" id="user_nickname" name="user_nickname" value="${nickname}" />
		<input type="text" id="user_image" name="user_image" value="${profile_image}" />
		<input type="text" id="user_heat" name="user_heat" value="평점" />
