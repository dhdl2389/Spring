...
public class ApiExamSearchBlog2 {
	...
	public String getNaverAPI() {
		String clientId = "tS29uqm2uIXEfFPFuVy2"; // 애플리케이션 클라이언트 아이디
		String clientSecret = "_dvnd_25Lx"; // 애플리케이션 클라이언트 시크릿

		String text = null;
		try {
			text = URLEncoder.encode("칼", "UTF-8");
