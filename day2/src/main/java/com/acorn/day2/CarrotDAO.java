...
public class CarrotDAO {
	...
	public void updateCarrot(String id, Integer newPrice, String newInfo ) throws SQLException {
	...
	public boolean RegisterCarrot(String id, int price, String info, Date date) throws SQLException {
		Connection con = ds.getConnection();
		PreparedStatement pst = null;
